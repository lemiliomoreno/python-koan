...
def function2():
    ...
    # The diference between a function and a method, is that the function doesn't
    # reffer to an object, and the method it does with the parameter 'self'
...
class AboutMethodBindings(Koan):
    ...
    def test_setting_attributes_on_a_bound_method_directly(self):
        ...
        # It will raise 'AttributeError' because the 'method' object has no attribute 'cherries'
    ...
    def test_inner_functions_are_unbound(self):
        ...
        # It raises 'AttributeError' because it doesn't have attribue 'self'
