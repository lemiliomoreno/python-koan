...
class AboutExceptions(Koan):
    ...
    def test_exceptions_inherit_from_exception(self):
        ...
        # The __name__ will store the information given by mro() of the object created
        # What does mro() does?
        # https://stackoverflow.com/questions/2010692/what-does-mro-do
        # The MRO (Method Resolution Order) defines the class search path used by Python
        # to search for the right method to use in classes having multi-inheritance
