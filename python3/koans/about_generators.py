...
class AboutGenerators(Koan):
    ...
    def test_generators_are_different_to_list_comprehensions(self):
        ...
        # The diference between this 2, is that the first will create a list[], and the second
        # one will create a set()
        ...
        # Can't be iterated, because it's a set
    ...
    def test_generator_expressions_are_a_one_shot_deal(self):
        ...
        # The generator will only use the list() once, the second time it's empty
        
    # ------------------------------------------------------------------

    # You want more about generators and yield?
    ...
    def test_generators_can_act_as_coroutines(self):
        ...
        #
        # It's necessary because, unless send() was called before, the yield 
        # value will be None
        #
    ...
    def test_before_sending_a_value_to_a_generator_next_must_be_called(self):
        ...
        # You can't call a just created generator with a non-None value, you
        # should use next(generator) first
    ...
    def test_generators_can_see_if_they_have_been_called_with_a_value(self):
        ...
        # Generator2 value is 'no value', because detects if a valued has been send
    ...
    def test_send_none_is_equivalent_to_next(self):
        ...
        # Because we sent None, it will enter the 'else'
