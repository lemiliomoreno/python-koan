...
class AboutInheritance(Koan):
    ...
    class BullDog(Dog):
        def bark(self):
            ...
            # The 'super()' method, allows to reffer to the superclass implicity
            # when initializing a subclass
            # NOTE: when calling 'super()' in '__init__' of a class, the '__init__'
            # doesn't have to call 'self', it's already reffering to the object 
            # when using 'super()'
