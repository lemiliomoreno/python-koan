...
class AboutIteration(Koan):
    ...
    def test_map_transforms_elements_of_a_list(self):
        ...
        # The method map, will add a value of 10 to each of the iterable item 
        # from in seq list
        # Mapping will be stored as a 'map' object, 'mapping variable' can be iterable
        # in a for loop like the example below
    ...
    def test_filter_selects_certain_items_from_a_list(self):
        ...
        # The method filter, will allow to use 'is_even' as a filter, for 'seq'
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # reduce() applies a particular function passed in its argument to
        ...
        # reduce() applies the function passed in the first parameter, to each
        # of the list items passed in the second parameter, initializing from 
        # the third parameter
    ...
    def test_all_iteration_methods_work_on_any_sequence_not_just_lists(self):
        ...
        try:
            ...
            try:
                ...
                self.assertEqual(['THISIS', 'A', 'TEST'], list(upcase_lines))
            finally:
                # Arg, this is ugly.
