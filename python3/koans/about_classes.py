...
class AboutClasses(Koan):
    ...
    def test_creating_properties_with_decorators_is_slightly_easier(self):
        ...
        # The '@property' tag, will indicate that it will only return the name in the method,
        # but when given a parameter it will use the '@name.setter' and replace the name with 
        # the new one
    ...
    def test_inside_a_method_self_refers_to_the_containing_object(self):
        ...
        self.assertEqual(fido.get_self(), fido.get_self())  # Not a string!, "<Dog named 'Fido'>"
    ...
    def test_all_objects_support_str_and_repr(self):
        ...
        # The purpose of 'str()' and 'repr()': they are used to get a string representation of an object
        # str(): more user-readable, for end-user
        # repr(): for debugging, if print a string will print quotes
