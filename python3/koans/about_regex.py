...
class AboutRegex(Koan):
    ...
    def test_matching_literal_text_how_many(self):
        ...
        # It's returning a none because match() only looks at the begining of the string
    ...
    def test_matching_any_character(self):
        ...
        change_this_search_string = '.a.\.xls' # Looking for files that has an a in the middle and finishes with .xls
        self.assertEquals(
