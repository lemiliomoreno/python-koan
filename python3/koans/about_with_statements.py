...
class AboutWithStatements(Koan):
    ...
    def test_counting_lines(self):
        self.assertEqual(3, self.count_lines("example_file.txt")) # It's 1, but the run.bat take it as 3
    ...
    def test_finding_lines(self):
        self.assertEqual('test', self.find_line("example_file.txt")) # I don't know where is the example_file that they are reading...
    ...
    def test_counting_lines2(self):
        self.assertEqual(3, self.count_lines2("example_file.txt"))
    ...
    def test_finding_lines2(self):
        ...
        self.assertEqual('test', self.find_line2("example_file.txt")) # The original was 'test\n'
    ...
    def test_open_already_has_its_own_built_in_context_manager(self):
        self.assertEqual(3, self.count_lines3("example_file.txt"))
